    ...
    <div id="smoother-content">
      ...
      <nav class="menu" id="menu">
        <ul class="menu_items">
          ...
          <li class="menu_item">
            <button data-nav-link="about-us" class="menu_item__link">About Us</button>
          </li>
          <li class="menu_item">
            <button data-nav-link="our-works" class="menu_item__link">Our works</button>
          </li>
          <li class="menu_item">
            <button data-nav-link="services" class="menu_item__link">Services</button>
          </li>
          <li class="menu_item">
            <button data-nav-link="cta" class="menu_item__link">Contacts</button>
          </li>
        </ul>
      </nav>
          ...
          <div class="header-content">
            <a href="#header" class="logo">
              <svg xmlns="http://www.w3.org/2000/svg" width="36" height="36" viewBox="0 0 36 36" fill="none">
                <path d="M0 36V0L8.36307 18.5182L6.26493 18.5143L2.05714 9.25714V33.9429H17.4857L29.8286 0H31.8857L19.5429 33.9429H21.6L33.9429 0H36L23.6571 33.9429H36V36H0Z" fill="white" />
                <path d="M14.4 31.8857H12.3429L8.13506 22.6286H10.2194L14.4 31.8857Z" fill="white" />
                <path d="M14.4 19.5429H3.08571V21.6H14.4V19.5429Z" fill="white" />
              </svg>
            ...
            <img id="header-img" data-speed="1.2" class="header-content__right" src="image/header-laptop.png" alt="">
          </div>
        </div>
      </header>
                ...
                <div>
                  <span style="--i: 0">
                    <svg xmlns="http://www.w3.org/2000/svg" width="250" height="250" viewBox="0 0 250 250" fill="none">
                      <path d="M0 250V0L58.0769 128.599L43.5065 128.571L14.2857 64.2857V235.714H121.429L207.143 0H221.429L135.714 235.714H150L235.714 0H250L164.286 235.714H250V250H0Z" fill="white" />
                      <path d="M100 221.429H85.7143L56.4935 157.143H70.9677L100 221.429Z" fill="white" />
                      <path d="M100 135.714H21.4286V150H100V135.714Z" fill="white" />
                    </svg>
                  </span>
                  <span style="--i: 1"></span>
                  <span style="--i: 2">
      ...
      <section data-section="our-works" id="our-works" class="our-works">
        ...
        <div id="content__right" class="content__right">
          <div class="cards">
            <a href="https://aleximasolutions.github.io/solution_fusion_lab/" target="_blank" class="card">
              <h3 class="card-title">Fusion Lab</h3>
              <img src="image/card1.png" alt="Fusion Lab">
            </a>
            <a href="https://aleximasolutions.github.io/lofthouse/" target="_blank" class="card">
              <h3 class="card-title">Loft House</h3>
              <img src="image/card2.png" alt="Loft House">
            </a>
            <a href="https://aleximasolutions.github.io/vue_cinema/" target="_blank" class="card">
              <h3 class="card-title">VUE cinema</h3>
              <img src="image/card3.png" alt="VUE cinema">
            </a>
            <a href="https://aleximasolutions.github.io/luxe/" target="_blank" class="card">
              <h3 class="card-title">Luxe</h3>
              <img src="image/card4.png" alt="Luxe">
            </a>
            <a href="https://aleximasolutions.github.io/SFLAB_TG_BOTS/" target="_blank" class="card">
              <h3 class="card-title">SFLAB bot</h3>
              <img src="image/card5.png" alt="SFLAB bot">
            </a>
            <a href="https://aleximasolutions.github.io/amind/" target="_blank" class="card">
              <h3 class="card-title">Amind</h3>
              <img src="image/card6.png" alt="Amind">
            </a>
            <!-- <a href="#" class="card">
                ...
                <ul class="service-cards">
                  <li class="service-card active" data-id="web">
                    <div class="service-card__icon">
                      <img src="image/icons/fi-rs-browser.svg" alt="Website Development">
                    </div>
                  ...
                  <li class="service-card" data-id="eshop">
                    <div class="service-card__icon">
                      <img src="image/icons/1.svg" alt="EshopSolutions">
                    </div>
      ...
      <section data-section="cta" id="cta" class="cta">
        <div class="container">
          <h2 class="cta-title title">Think we could be a match?</h2>
            ...
            <form id="form" action="#" method="POST" class="cta__form">
              <div id="main-success" class="notification_items">
                <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" fill="none">
                  <g clip-path="url(#a)">
                    <path fill="#fff" d="M24 0a24 24 0 1 0 0 48 24 24 0 0 0 0-48Zm0 44a20 20 0 1 1 0-40 20 20 0 0 1 0 40Z" />
                  </g>
                  <path fill="#fff" d="M19.55 30.53 13.02 24a1.67 1.67 0 0 0-2.35 2.36l6.53 6.53a3.33 3.33 0 0 0 4.71 0l15.42-15.42a1.67 1.67 0 0 0 0-2.36 1.67 1.67 0 0 0-2.35 0L19.55 30.53Z" />
                  <defs>
                    <clipPath id="a">
              ...
              <div id="main-error" class="notification_items">
                <svg xmlns="http://www.w3.org/2000/svg" width="48" height="48" fill="none">
                  <g fill="#fff" clip-path="url(#b)">
                    <path d="M32 16a2 2 0 0 0-2.83 0L24 21.17 18.83 16A2 2 0 0 0 16 18.83L21.17 24 16 29.17A2 2 0 0 0 18.83 32L24 26.83 29.17 32A2 2 0 0 0 32 29.17L26.83 24 32 18.83A2 2 0 0 0 32 16Z" />
                    <path d="M24 0a24 24 0 1 0 0 48 24 24 0 0 0 0-48Zm0 44a20 20 0 1 1 0-40 20 20 0 0 1 0 40Z" />
                  </g>
                  <defs>
                    <clipPath id="b">
                      <path fill="#fff" d="M0 0h48v48H0z" />
              ...
              <div class="input_wrapper"><input class="form-input" id="phone" name="phone" type="text" placeholder="Phone"><span class="error"></span></div>
              <div class="input_wrapper">
                <input class="form-input" id="email" name="email" type="text" placeholder="Email"><span class="error"></span>
              </div>
        ...
        <div class="container">
          <div class="footer-content">
            ...
            <ul class="footer__list">
              ...
              <li class="footer__list-item">
                <button data-nav-link="about-us" class="footer__list-link"> About Us </button>
              </li>
              <li class="footer__list-item">
                <button data-nav-link="our-works" class="footer__list-link"> Our works </button>
              </li>
              <li class="footer__list-item">
                <button data-nav-link="services" class="footer__list-link"> Services </button>
              </li>
              <li class="footer__list-item">
                <button data-nav-link="cta" class="footer__list-link"> Contact Us </button>
              </li>
            </ul>
            ...
            <li class="footer__list-item">
              ...
              <li class="footer__list-item">
                Adress:
                <address class="footer__list-link">
                  Kurzova 2202/20, Prague, Czech Republic
                </address>
              </li>
              <li class="footer__list-item">
                Email:
                <a href="mailto:dev.aleximasolutions@gmail.com" class="footer__list-link">
